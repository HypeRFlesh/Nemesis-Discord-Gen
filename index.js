...
bot.on("message", async message => {	
    ...
    if (command === "gen") {	
        if(message.channel.id !== "779800583259029518") return message.channel.send("This command can be runned only in the generate channel")	
